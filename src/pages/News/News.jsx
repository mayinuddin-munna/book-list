...
import blog2 from '../../assets/img/h-blog/02.png';
import blog3 from '../../assets/img/h-blog/03.png';
                        ...
                        <div className="blog-grid-item">
                            ...
                            <div className="content">
                                <ul className="post-categories">
                                    <li><img src={calender} alt=""/>19th Jan 2022</li>
                                    <li>12 noon to 4 pm</li>
                                </ul>
                                <h4 className="title">Overseas Education Fair Maravedi 2024</h4>
                                <div className="btn-wrap">
                                    <a href="#0" className="more-btn">Read More <i
                                            className="fa-solid fa-angle-right icon"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
