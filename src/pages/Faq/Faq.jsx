          ...
          <div className="col-lg-6">
            ...
            <div className="faq-content">
              <h6 className="subtitle">
                Still do you have any questions to know? <br /> Feel free to ask
                our experts here.
              </h6>
                ...
                <div className="card">
                  ...
                  >
                    <div className="card-body">
                      Norway, USA, UK, Germany & Italy is most safest country in
                      the world for Bangladeshi students for higher study.
                    </div>
                  </div>
                </div>
                <div className="card">
                ...
                <div className="card">
                  <div className="card-header" id="headingSix">
                    <h5 className="mb-0">
                      ...
                      >
                        6. Do you allow accommodation for students in abroad?
                      </a>
                    </h5>
                  </div>
                  <div
